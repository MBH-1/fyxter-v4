      ...
      <main className="container mx-auto px-4 py-10 max-w-5xl">
        ...
        <section className="mb-10">
          ...
          <ul className="grid grid-cols-1 md:grid-cols-2 gap-2 text-blue-600">
            <li><Link to="/repair/iphone/iphone-xr">iPhone X / iPhone XR</Link></li>
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-700">
            ...
            <strong>$49 to $549</strong>, depending on the model and screen type.
...
<section className="mb-10">
  <h2 className="text-2xl font-semibold mb-3">
    iPhone Screen Repair Across Montreal
  </h2>
  <p className="text-gray-700">
    Fyxters connects you with the closest available iPhone repair technician
    based on your location. Using our live technician map, we assign the nearest
    qualified technician to ensure fast, same-day service anywhere in Montreal
    and surrounding areas, including Laval, Brossard, and the West Island.
  </p>
</section>
